...
import controller.ReturnComfirmHandler;
...
public class ReturnRoomCheck extends GridPane {

	public ReturnRoomCheck(BorderPane pane) {
		...
		checkButton.setOnAction(new ReturnComfirmHandler(pane, roomIDInput));
