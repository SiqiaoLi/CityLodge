...
import controller.RentSuiteSucessHandler;
...
public class AvailabeSuiteView extends GridPane {

	public AvailabeSuiteView(BorderPane pane, String roomID) {
		...
		rentButton.setOnAction(new RentSuiteSucessHandler(pane, roomID, cusIDInput, rentDateInput, numberOfDaysInput));
