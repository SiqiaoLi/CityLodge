...
import controller.RentComfirmHandler;
...
public class RentRoomCheck extends GridPane {

	public RentRoomCheck(BorderPane pane) {
		...
		checkButton.setOnAction(new RentComfirmHandler(pane, roomIDInput));
