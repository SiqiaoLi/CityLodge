...
import controller.ImportRoomHandler;
...
public class ImportRoomView extends GridPane {
	
	public ImportRoomView(BorderPane pane) {
		...
		// Title
		Text title = new Text("Import room");
		...
		importButton.setOnAction(new ImportRoomHandler(pane));
