...
import controller.MaintenComfirmHandler;
...
public class MaintenRoomCheck extends GridPane{
	
	public MaintenRoomCheck(BorderPane pane) {
		// GridPane with 10px padding around edge
				...
				checkButton.setOnAction(new MaintenComfirmHandler(pane, roomIDInput));
